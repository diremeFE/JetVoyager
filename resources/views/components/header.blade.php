    <header class="bg-primary-black text-white">
        ...
        <nav id="menu" class=" p-5 hidden lg:flex justify-end items-center space-x-6 text-md">
            ...
            <a href="/flights" class="hover:text-yellow">Buscar vuelos</a>
            <a href="/reservations" class="hover:text-yellow">Mis reservas</a>
            <a href="/offers" class="hover:text-yellow">Ofertas especiales</a>
            <a href="/airport-info" class="hover:text-yellow">Información de aeropuertos</a>
        </nav>
    </header>
