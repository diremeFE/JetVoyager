<div class="relative max-w-xs h-80 p-2 shadow-lg rounded-3xl overflow-hidden transition-transform duration-300 ease-in-out hover:scale-105" 
    ...
    <div class="relative z-10 text-white p-4 rounded-lg flex flex-col justify-end h-full">
        ...
        <button class="bg-yellow text-black font-medium px-4 py-2 rounded-full flex items-center justify-center transition-colors duration-300">
