    ...
    <div class="max-w-5xl mx-auto px-6 py-8">
        ...
        <section class="mt-20 flex flex-col justify-center items-center">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
                <!-- Plan JetLite -->
                <div class="bg-white border border-gray-200 rounded-lg shadow-sm p-6 text-center flex flex-col transition-transform duration-300 ease-in-out hover:scale-105">
                    ...
                    <div class="mt-auto">
                        <button class="text-md font-bold bg-yellow hover:bg-yellow-hover rounded-full px-4 py-3 mt-4">+ 35,00 EUR/PERSONA</button>
                        <p class="text-sm text-gray-500">sobre el precio del billete</p>
                    </div>
                </div>
            
                <!-- Plan JetPremium (destacado) -->
                <div class="bg-white border-4 border-yellow rounded-lg shadow-lg p-6 text-center flex flex-col transition-transform duration-300 ease-in-out hover:scale-105">
                    ...
                    <div class="mt-auto">
                        <button class="text-md font-bold bg-yellow hover:bg-yellow-hover rounded-full px-4 py-3 mt-4">+ 84,00 EUR/PERSONA</button>
                        <p class="text-sm text-gray-500">sobre el precio del billete</p>
                    </div>
                </div>
                ...
                <div class="bg-white border border-gray-200 rounded-lg shadow-sm p-6 text-center flex flex-col transition-transform duration-300 ease-in-out hover:scale-105">
                    ...
                    <div class="mt-auto">
                        <button class="text-md font-bold bg-yellow hover:bg-yellow-hover rounded-full px-4 py-3 mt-4">+ 60,00 EUR/PERSONA</button>
                        <p class="text-sm text-gray-500">sobre el precio del billete</p>
                    </div>
                </div>
            </div>
